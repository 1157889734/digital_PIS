...
#define	HLED_SoftWareVersion	1		//车头屏软件版本
//#define	IP_offset				(12)		//dmp相对1号中控的ip偏移
#define	IP_offset				(140)	//车头屏相对1号中控的ip偏移
//#define	IP_resSUM				(80)		//PIS 系统中dmp 的预留ip数量
#define	IP_resSUM				(2)		//PIS 系统中车头屏的预留ip数量

#define	FirstCentrolController_ID	(0x01)	//第一块中控的id
#define	Firstdmp_ID				(0x01)	//第一块动态地图的id
#define	FirstHLED_ID				(0x01)	//第一块车头屏的id
...
#define	LIGHT_LED_INTERVAL1	(50)	//自检方式一间隔
#define	LIGHT_LED_INTERVAL2	(50)	//自检方式二 间隔
#define	LIGHT_LED_INTERVAL3	(50)	//自检方式三间隔

#ifdef TEST_MODE
#define	led_map_SUM	1			//工厂测试模式只用一块显示板
#else
#define	led_map_SUM	2			//动态地图显示板的数量
#endif

#define	HC595_NUM		7			//每块动态显示板控制红/绿led的74hc595 各自的数量

#define	STATION_SUM	32			//车站数量

#define	FIRST_STATION_charNum		0	//led的起点位置
#define	FIRST_STATION_bitNum		2

#define	ThisDoor_charNum		6	//本侧开门指示灯位置
#define	ThisDoor_bitNum			1

#define	OppositeDoor_charNum		6	//对侧开门指示灯位置
#define	OppositeDoor_bitNum			0
